...
<template>
  <Card :key="bookmark.$id">
      <CardHeader v-if="props.bookmark.imageUrl" class="p-0 relative"> <img
    ...
    <CardHeader >
      ...
      <CardDescription>
        <a :href="bookmark.url" target="_blank" rel="noopener noreferrer" class="pb-4 text-blue-600 hover:underline break-all">
          {{ bookmark.url }}
        </a>
      </CardDescription>
      </CardHeader>
